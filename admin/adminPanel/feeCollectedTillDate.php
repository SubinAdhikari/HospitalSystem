...
$feecollected=selectFeeCollectedTable($conn);
?>
   <!-- BEGIN CONTAINER -->
...
<div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Fee Collected Till Date</h4>
                            <span class="tools">
                    ...
                    <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">Collected By</th>
                                <th class="hidden-phone">Fee Paid</th>
                            ...
                            <?php
                                ...
                                foreach($feecollected as $key){                                
                                ?>
                            <tr class="odd gradeX">
                                <td><input type="checkbox" class="checkboxes" value="1" /></td>
                                <td><?php echo $key['reg_no']; ?></td>
                                <td class="hidden-phone"><?php echo $key['collected_by']; ?></td>
                                <td class="hidden-phone"><?php echo $key['fees_paid']; ?></td>

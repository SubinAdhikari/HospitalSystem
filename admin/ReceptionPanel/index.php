            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-orange">
                        <a data-original-title="" href="addPatient.php">
                            <i class="icon-user"></i>
                            <div class="info">321</div>
                            <div class="status">Add New Patient</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-olive">
                        <a data-original-title="" href="makeAppointment.php">
                            <i class="icon-tags"></i>
                            <div class="info">+970</div>
                            <div class="status">Make Appointment</div>
                        </a>
                    </div>
                    <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="" href="patientDetails.php">

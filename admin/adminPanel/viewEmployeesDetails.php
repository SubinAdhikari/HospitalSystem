...
$doctorsDetails=selectAllDoctors($conn);
$ReceptionistDetails=selectAllReceptionist($conn);
?>
   <!-- BEGIN CONTAINER -->
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th class="hidden-phone">PhoneNo</th>
                                <th class="hidden-phone">Address</th>
                                <th class="hidden-phone">Field</th>
                                <th class="hidden-phone">Certificateno</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($doctorsDetails as $key){ ?>
                            <tr class="odd gradeX">
                                <td><input type="checkbox" class="checkboxes" value="1" /></td>
                                <td><?php echo $key['name']; ?></td>
                                <td class="hidden-phone"><a href="#"><?php echo $key['email']; ?></a></td>
                                <td class="hidden-phone"><?php echo $key['phoneno']; ?></td>
                                <td class="center hidden-phone"><?php echo $key['address']; ?></td>
                                <td class="hidden-phone"><span class="label label-success"><?php echo $key['doctor_field']; ?></span></td>
                                <td class="hidden-phone"><?php echo $key['certificate_number']; ?></td>
                            </tr><?php } ?>
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php foreach($ReceptionistDetails as $key){ ?>
                            <tr class="odd gradeX">
                                <td><input type="checkbox" class="checkboxes" value="1" /></td>
                                <td><?php echo $key['name']; ?></td>
                                <td class="hidden-phone"><a href="#"><?php echo $key['email']; ?></a></td>

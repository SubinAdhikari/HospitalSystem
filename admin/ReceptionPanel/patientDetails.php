                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tbody>
                            <?php
                                $result=ViewAllPatient($conn);
                                foreach($result as $key){                                
                                ?>
                            <tr class="odd gradeX">
                                <td><input type="checkbox" class="checkboxes" value="1" /></td>
                                <td><?php echo $key['reg_no']; ?></td>
                                <td class="hidden-phone"><?php echo $key['name']; ?></td>
                                <td class="hidden-phone"><?php echo $key['phoneno']; ?></td>
                                <td class="center hidden-phone"><?php echo $key['address']; ?></td>
                                <!-- <td class="hidden-phone"><span class="label label-success">Approved</span></td> -->
                                <td class="hidden-phone"><a href="patientFeeDetails.php?ref=<?php echo $key['reg_no'];?>">Details</a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>

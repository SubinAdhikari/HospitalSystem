                    ...
                    <div class="widget yellow">
                        ...
                        <div class="widget-body form">
                            ...
                            <form class="cmxform form-horizontal" id="commentForm" method="POST" action="">
                                ...
                                <div class="control-group ">
                                    <label for="curl" class="control-label">Phone-no (required)</label>
                                    <div class="controls">
                                        <input class="span6 " id="curl" type="text" name="phoneno" />
                                    </div>
                                </div>
...
if(isset($_POST['submitbtn'])){
    if(addPatient($conn,$_POST)){
        echo '<script language="javascript">';
    echo 'alert("successfully Added Patient")';
    echo '</script>';
    }else{
        echo '<script language="javascript">';
        echo 'alert("Failed Adding Patient")';
        echo '</script>';
    }
}
